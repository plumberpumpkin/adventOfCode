...
fn day_two_part_one(input:[&str; 1000]){
    ...
    for present in input{
        ...
        println!("L: {}, W: {}, H: {}", dimensions[0], dimensions[1], dimensions[2]);
        let side_one: i32 = dimensions[0] * dimensions[1];
        println!("Side One Size {}", side_one);
        let side_two: i32 = dimensions[1] * dimensions[2];
        println!("Side Two Size {}", side_two);
        let side_three: i32 =dimensions[2] * dimensions[0];
        println!("Side three Size {}", side_three);
        ...
        println!("smallest Side {}", smallest_side);
        ...
        println!("total size of present: {}", present_paper_size);
        total_paper_amount += present_paper_size; 
        println!("Interim total amount {}", total_paper_amount);     
